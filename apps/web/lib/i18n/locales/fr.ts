...
export const fr = {
  ...
  "champion.back": "Tous les champions",
  "champion.lore": "Histoire",
  "champion.abilities": "Compétences",
  "champion.passive": "Passif",
  "champion.baseStats": "Statistiques de base",
  "champion.perLevel": "par niveau",
  "champion.cooldown": "Délai de récup.",
  "champion.cost": "Coût",
  ...
  "champion.stat.ad": "Dégâts d'attaque",
  "champion.stat.armor": "Armure",
  "champion.stat.mr": "Résist. magique",
  "champion.stat.as": "Vitesse d'attaque",
  "champion.stat.ms": "Vitesse de déplacement",
  "champion.stat.range": "Portée d'attaque",
  ...
  "items.title": "Objets",
  "items.subtitle": "Base d'objets \u2014 stats, co\u00fbt et chemins de build.",
  "items.search": "Rechercher un objet\u2026",
  "items.none": "Aucun objet.",
  "items.unavailable": "Objets indisponibles.",
  "items.gold": "{total} or \u00b7 revente {sell}",
  "items.buildsFrom": "Compos\u00e9 de",
  "runes.title": "Runes",
  "runes.subtitle": "Les cinq arbres de runes et leurs runes.",
  "runes.unavailable": "Runes indisponibles.",
  "featured.title": "Parties en direct",
  "featured.subtitle": "Une s\u00e9lection de parties en cours actuellement.",
  "featured.empty": "Aucune partie mise en avant pour le moment.",
  "featured.unavailable": "Parties en direct indisponibles.",
  "nav.items": "Objets",
  "nav.runes": "Runes",
  "nav.liveGames": "Parties en direct",
  ...
  "status.title": "Statut des serveurs",
  "status.ok": "Tout fonctionne normalement",
