...
export const en = {
  ...
  "champion.back": "All champions",
  "champion.lore": "Lore",
  "champion.abilities": "Abilities",
  "champion.passive": "Passive",
  "champion.baseStats": "Base stats",
  "champion.perLevel": "per level",
  ...
  "champion.stat.ad": "Attack damage",
  "champion.stat.armor": "Armor",
  "champion.stat.mr": "Magic resist",
  "champion.stat.as": "Attack speed",
  "champion.stat.ms": "Move speed",
  "champion.stat.range": "Attack range",
  ...
  "items.title": "Items",
  "items.subtitle": "Item database \u2014 stats, cost and build paths.",
  "items.search": "Search an item\u2026",
  "items.none": "No item.",
  "items.unavailable": "Items unavailable.",
  "items.gold": "{total} gold \u00b7 sells for {sell}",
  "items.buildsFrom": "Builds from",
  "runes.title": "Runes",
  "runes.subtitle": "The five rune trees and their runes.",
  "runes.unavailable": "Runes unavailable.",
  "featured.title": "Live games",
  "featured.subtitle": "A selection of games in progress right now.",
  "featured.empty": "No featured game right now.",
  "featured.unavailable": "Live games unavailable.",
  "nav.items": "Items",
  "nav.runes": "Runes",
  "nav.liveGames": "Live games",
  "patch.title": "Patch notes",
  "patch.subtitle": "Latest League of Legends patch notes.",
  "patch.latest": "Latest patch",
  "patch.read": "Read the notes",
  "patch.all": "All patch notes",
  "patch.unavailable": "Patch list unavailable right now.",
