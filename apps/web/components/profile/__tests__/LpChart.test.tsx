...
const mockData = [
  ...
  { dateMs: SEASON_2_2026_START_MS + 2 * 86400000, tier: "Diamond" as const, division: "III", lp: 80 },
  { dateMs: SEASON_2_2026_START_MS + 3 * 86400000, tier: "Diamond" as const, division: "III", lp: 20, isPeak: false },
]

describe("LpChart", () => {
  it("renders without throwing", () => {
    expect(() => render(<LpChart region="EUW1" gameName="Test" tagLine="EUW" data={mockData} />)).not.toThrow()
  })

  it("shows peak marker in gold", () => {
    const { container } = render(<LpChart region="EUW1" gameName="Test" tagLine="EUW" data={mockData} />)
